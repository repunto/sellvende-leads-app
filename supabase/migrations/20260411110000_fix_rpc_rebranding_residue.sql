-- ====================================================================================
-- FIX: get_filtered_lead_ids still referenced dead column "tour_nombre"
-- The column was renamed to "producto_interes" in migration 20260409100000_b2b_crm_rename.sql
-- but this RPC was created BEFORE that rename and was never updated.
-- ====================================================================================
...
GRANT EXECUTE ON FUNCTION get_filtered_lead_ids TO authenticated, service_role;
